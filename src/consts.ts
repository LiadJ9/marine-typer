...
export const MOBY_QUOTES = [
  ...
  'I have no objection to any persons religion, be it what it may, so long as that person does not kill or insult any other person, because that other person dont believe it also.',
  ...
  'With the landless gull, that at sunset folds her wings and is rocked to sleep between billows; so at nightfall, the Nantucketer, out of sight of land, furls his sails, and lays him to his rest.',
  'A noble craft, but somehow a most melancholy! All noble things are touched with that.',
  'I have no objection to any persons religion, be it what it may, so long as that person does not kill or insult any other person, because that other person dont believe it also. But when a mans religion becomes really frantic; when it is a positive torment to him; and, in fine, makes this earth of ours an uncomfortable inn to lodge in; then I think it high time to take that individual aside and argue the point with him.',
  ...
  '"Do tell, now," cried Bildad, "is this Philistine a regular member of Deacon Deuteronomys meeting? I never saw him going there, and I pass it every Lords day."',
  '"I dont know anything about Deacon Deuteronomy or his meeting," said I; "all I know is, that Queequeg here is a born member of the First Congregational Church. He is a deacon himself, Queequeg is."',
  ...
  '"Splice, thou meanst splice hands," cried Peleg, drawing nearer. "Young man, youd better ship for a missionary, instead of a fore-mast hand; I never heard a better sermon..."',
  'Quick, I say, you Bildad, and get the ships papers. We must have Hedgehog there, I mean Quohog, in one of our boats. Look ye, Quohog, well give ye the ninetieth lay, and thats more than ever was given a harpooneer yet out of Nantucket.',
  ...
  'Damn me, its worth a fellows while to be born into the world, if only to fall right asleep. And now that I think of it, thats about the first thing babies do, and thats a sort of queer, too. Damn me, but all things are queer, come to think of em. But thats against my principles. Think not, is my eleventh commandment; and sleep when you can, is my twelfth - So here goes again.',
  'Old age is always wakeful; as if, the longer linked with life, the less man has to do with aught that looks like death.',

  'For small erections may be finished by their first architects; grand ones, true ones, ever leave the copestone to posterity. God keep me from ever completing anything.',

  'This it is, that for ever keeps Gods true princes of the Empire from the worlds hustings; and leaves the highest honors that this air can give, to those men who become famous more through their infinite inferiority to the choice hidden handful of the Divine Inert, than through their undoubted superiority over the dead level of the mass.',
  ...
  'An old, old sight, and yet somehow so young; aye, and not changed a wink since I first saw it, a boy, from the sand-hills of Nantucket! The same - the same! - the same to Noah as to me.',
];
